...
// --- MODELO CARGA (MAPEO DE LOGISV20) ---
...
app.get('/', async (req, res) => {
  try {
    ...
    // Crear registros contables si no existen
    ...
    res.send(`<html><head><title>YEGO Finanzas</title>${css}</head><body>
      <div class="container">
        ...
        <div class="table-container">
          <table>
            <thead>
              <tr><th>ID</th><th>PLACA</th><th>CLIENTE</th><th>FECHA</th><th>VALOR FLETE</th><th>ESTADO</th><th>DESPACHADOR</th><th>ACCIONES</th></tr>
            </thead>
            <tbody>${filas}</tbody>
          </table>
        </div>

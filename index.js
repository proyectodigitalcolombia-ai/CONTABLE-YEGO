...
// MODELO COMPLETO CON MAPEADO DE CAMPOS PARA EVITAR VALORES EN 0
const Finanza = db.define('Finanza', {
  ...
  tipo_anticipo: { type: DataTypes.STRING, field: 'TIPO_ANTICIPO' },
  valor_anticipo: { type: DataTypes.DECIMAL(15, 2), defaultValue: 0, field: 'VALOR_ANTICIPO' },
  sobre_anticipo: { type: DataTypes.DECIMAL(15, 2), defaultValue: 0, field: 'SOBRE_ANTICIPO' },
  estado_ant: { type: DataTypes.STRING, field: 'ESTADO_ANT' },
  fecha_pago_ant: { type: DataTypes.DATEONLY, field: 'FECHA_PAGO_ANT' },
  tipo_cumplido: { type: DataTypes.STRING, field: 'TIPO_CUMPLIDO' },
  fecha_cump_virtual: { type: DataTypes.DATEONLY, field: 'FECHA_CUMP_VIRTUAL' },
  ent_manifiesto: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_MANIFIESTO' },
  ent_remesa: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_REMESA' },
  ent_hoja_tiempos: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_HOJA_TIEMPOS' },
  ent_docs_cliente: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_DOCS_CLIENTE' },
  ent_facturas: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_FACTURAS' },
  ent_tirilla_vacio: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_TIRILLA_VACIO' },
  ent_tiq_cargue: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_TIQ_CARGUE' },
  ent_tiq_descargue: { type: DataTypes.STRING, defaultValue: 'NO', field: 'ENT_TIQ_DESCARGUE' },
  presenta_novedades: { type: DataTypes.STRING, defaultValue: 'NO', field: 'PRESENTA_NOVEDADES' },
  obs_novedad: { type: DataTypes.TEXT, field: 'OBS_NOVEDAD' },
  valor_descuento: { type: DataTypes.DECIMAL(15, 2), defaultValue: 0, field: 'VALOR_DESCUENTO' },
  fecha_cump_docs: { type: DataTypes.DATEONLY, field: 'FECHA_CUMP_DOCS' },
  fecha_legalizacion: { type: DataTypes.DATEONLY, field: 'FECHA_LEGALIZACION' },
  retefuente: { type: DataTypes.DECIMAL(15, 2), defaultValue: 0, field: 'RETEFUENTE' },
  reteica: { type: DataTypes.DECIMAL(15, 2), defaultValue: 0, field: 'RETEICA' },
  saldo_a_pagar: { type: DataTypes.DECIMAL(15, 2), defaultValue: 0, field: 'SALDO_A_PAGAR' },
  estado_final: { type: DataTypes.STRING, defaultValue: 'PENDIENTE', field: 'ESTADO_FINAL' },
  dias_sin_pagar: { type: DataTypes.INTEGER, defaultValue: 0, field: 'DIAS_SIN_PAGAR' },
  dias_sin_cumplir: { type: DataTypes.INTEGER, defaultValue: 0, field: 'DIAS_SIN_CUMPLIR' }
